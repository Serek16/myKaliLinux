...
xfconf-query -c xfce4-keyboard-shortcuts -p "/xfwm4/custom/<Alt><Shift>A" -n -t string -s "move_window_left_workspace_key"
...
xfconf-query -c xfce4-keyboard-shortcuts -p "/xfwm4/custom/<Alt><Shift>D" -n -t string -s "move_window_right_workspace_key"

# Remove default: Ctrl + Alt {Up/Down}
